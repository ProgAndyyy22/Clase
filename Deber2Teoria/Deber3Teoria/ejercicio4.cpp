...
bool EntraCine1 = ((edad1 <65) &&(edad1 >= 18));
bool EntraCine2 = ((edad2 <65)&&(edad2 >= 18));
bool EntraCine3 = ((edad3<65)&&(edad3 >= 18));
...
if(EntraCine1){BoletosAdultos+=1;}
if(EntraCine2){BoletosAdultos+=1;}
...
cout << "Hay un menor de edad, y un adulto tiene que acompañarlos a la sala de entretenimiento." << endl;
    ...
    if (EntraPersona1Sala){
        ...
        if (edad2> edad3){cout<< "La tercera persona va a acompañar al menor de edad"<< endl; if(esAnciano2){BoletosAncianos+=1;}; if(EntraCine2){BoletosAdultos+=1;}}
        else{cout<<"La segunda persona va a acompañar al menor de edad"<<endl;if(esAnciano3){BoletosAncianos+=1;}; if(EntraCine3){BoletosAdultos+=1;}}}
    else if (EntraPersona2Sala){

        if (edad3> edad1){cout<< "La primera persona va a acompañar al menor de edad"<< endl;if(esAnciano3){BoletosAncianos+=1;}; if(EntraCine3){BoletosAdultos+=1;}}
        else{cout<<"La tercera persona va a acompañar al menor de edad"<<endl;if(esAnciano1){BoletosAncianos+=1;}; if(EntraCine1){BoletosAdultos+=1;}}}
    else if (EntraPersona3Sala){

        if (edad1> edad2){cout<< "La segunda persona va a acompañar al menor de edad"<< endl;if(esAnciano1){BoletosAncianos+=1;}; if(EntraCine1){BoletosAdultos+=1;}}
